...
class BlogApiControllerTest {
    ...
    public void deleteArticle() throws Exception {
        ...
        assertThat(articles).doesNotContain(savedArticle);
    ...
    public void updateArticle() throws Exception {
        ...
        Article article = blogRepository.findById(savedArticle.getId()).orElseThrow(() -> new IllegalArgumentException("게시물을 찾을 수 없습니다."));
